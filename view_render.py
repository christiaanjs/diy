#!/usr/bin/env python3
"""
view_render.py — start the live viewer for a project and capture a screenshot.

The screenshot is saved to projects/<slug>/preview.png so Claude Code can
read it and verify the rendered model visually.

Usage:
  python view_render.py <project>               # start server, take screenshot, open browser
  python view_render.py <project> --no-browser  # screenshot only, don't open browser
  python view_render.py <project> --no-shot     # open browser only, no screenshot
